...
export default function Plans(props: any) {
  return (
    <>
      <div className="flex sm:grid sm:grid-cols-2 md:grid-cols-3 gap-5 lg:gap-10 md:items-end overflow-auto md:overflow-visible">
         <div className="bg-dark shrink-0 max-w-full w-[calc(100vw-70px)] md:w-auto rounded-xl border border-white/10 p-5 lg:p-10 flex flex-col gap-8 overflow-hidden relative">
            <div className="space-y-3">
                <h3 className="text-2xl text-[#FCC979]">Growth</h3>
                <p className="text-white/70">Best suited for brands under 50k visitors/month</p>
                <p className="text-sm text-white tracking-wider"><span className="text-2xl font-semibold">$<span className="text-3xl"> 59.</span>00</span> month</p>
            </div>
         ...
         <div className="bg-dark shrink-0 max-w-full w-[calc(100vw-70px)] md:w-auto rounded-xl border border-white/10 p-5 lg:p-10 flex flex-col gap-8 overflow-hidden relative pb-10 lg:pb-14">
            <div className="space-y-3">
                <h3 className="text-2xl text-[#9773FE]">Scale</h3>
                <p className="text-white/70">Best suited for brands under 50k visitors/month</p>
                <p className="text-sm text-white tracking-wider"><span className="text-2xl font-semibold">$<span className="text-3xl"> 159.</span>00</span> month</p>
            </div>
            <div className="relative">
            <Link href="" className="bg-white rounded shrink-0 p-px flex text-center ">
         ...
         <div className="bg-dark shrink-0 max-w-full w-[calc(100vw-70px)] md:w-auto rounded-xl border border-white/10 p-5 lg:p-10 flex flex-col gap-8 overflow-hidden relative">
            <div className="space-y-3">
                <h3 className="text-2xl text-[#94DEC5]">Premium</h3>
                <p className="text-white/70">Best suited for brands under 50k visitors/month</p>
                <p className="text-sm text-white tracking-wider"><span className="text-2xl font-semibold">$<span className="text-3xl"> 199.</span>00</span> month</p>
            </div>
            <div className="relative">
