...
import AIImageServices from "./AIImageServices";
import EffyImageGenerator from "./EffyImageGenerator";
import EffyImageTools from "./EffyImageTools";
...
export default function Webdevelopment(props: any) {
  ...
  return (
    <>
      <Head>
        <title>effyAI Voice | effyAI powered Text to Voice Generator</title>
        <meta
          name="description"
      ...
      <div className="overflow-hidden">
        <Header />
        {/* hero section */}
        <div className="bg-center bg-no-repeat bg-contain bg-[#0D1021] voice-hero-bg">
          <div className="bg-linear-2 backdrop-blur-xl bg-left-top">
            <div className="pt-16 border-b border-white/10 xl:border-0 ">
          ...
          <section className="relative z-10 border-b border-white/20 xl:border-0 pb-10 xl:pb-0 pt-10 lg:pt-24 xl:pt-32 overflow-hidden xl:overflow-visible">
            ...
            <div className="relative space-y-10 xl:space-y-14 ">
              <div className="max-w-3xl mx-auto">
                ...
                EffyAI Image Tool for for every 
                    industry & Everyone
                </h2>
